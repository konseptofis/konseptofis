...
import HizmetlerimizItemListJsonLd from "@/app/components/seo/HizmetlerimizItemListJsonLd";
...
export default function HizmetlerimizPage() {
  return (
    <>
      ...
      <WhyKonseptOfisSection sectionClassName={ZEBRA_GREEN} linkPricingPhrase />
