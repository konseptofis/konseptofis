...
/** Mobil sabit alt CTA: WhatsApp + Ara (md ve üstü gizli). */
export default function MobileContactBar() {
  return (
    <nav
      className="fixed inset-x-0 bottom-0 z-40 border-t border-black/[0.06] bg-white/95 shadow-[0_-6px_24px_rgba(0,0,0,0.08)] backdrop-blur-md md:hidden"
